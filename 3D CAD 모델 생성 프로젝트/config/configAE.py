...
class ConfigAE(object):
    ...
    def set_configuration(self):
        ...
        self.attn_type = 0 # 0: transformer-xl, 1: transformer
        self.d_head = 4
    ...
    def parse(self):
        ...
        parser.add_argument('-n', '--nr_epochs', type=int, default=1000, help="total number of epochs to train")
        ...
        parser.add_argument('--vis_frequency', type=int, default=200, help="visualize output every x iterations")
        parser.add_argument('--augment', action='store_true', help="use random data augmentation")
        parser.add_argument('--use_VAE', action='store_true', help="use VAE method")
        
        if not self.is_train:
            parser.add_argument('-m', '--mode', type=str, choices=['rec', 'enc', 'dec', 'enc_mem', 'dec_mem'])
